# Generated by Django 3.0.2 on 2020-02-10 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Hospital.Person')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
            fields=[
                ...
                ('Staff', models.ManyToManyField(blank=True, related_name='staffName', to='Hospital.StaffLog')),
            ],
        ),
        migrations.CreateModel(
            name='Assigned_Room',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('RoomNo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='RoomNo', to='Hospital.Rooms')),
                ('patientName', models.ManyToManyField(to='Hospital.patient')),
            ],
        ),
    ]
